            ...
            <div class="w-full mt-3 text-center sm:mt-0 sm:mx-4 sm:text-left dark:text-white">
              ...
              <div class="mt-2">
                ...
                <div class="flex flex-col mt-1 w-full justify-between text-left">
                  <p class="text-sm text-gray-500 dark:text-white">Checklist for New Car ✌🏻</p>
                  <div class="text-sm text-gray-500 dark:text-white">
                    <ul class="list-disc pl-4">
                      <li>Add checklist page for new car inspection</li>
                      <li>Support save checklist state to localStorage</li>
                    </ul>
                  </div>
                </div>
